...
#	SET(SDL_LIBRARY_MAIN "${BLURRR_SDK_PATH}/SDL2/libs/${ANDROID_ABI}/libSDL2main.so" CACHE STRING "SDLmain library")
	...
	SET(CURL_INCLUDE_DIR "${BLURRR_SDK_PATH}/curl/include" CACHE STRING "curl include directory")
	SET(CURL_INCLUDE_DIR_FLAT "${BLURRR_SDK_PATH}/curl/include/curl" CACHE STRING "curl include directory")
	SET(CURL_INCLUDE_DIRS "${CURL_INCLUDE_DIR_FLAT};${CURL_INCLUDE_DIR}" CACHE STRING "curl include directory")
	SET(CURL_LIBRARY "${BLURRR_SDK_PATH}/curl/libs/${ANDROID_ABI}/libcurl.so" CACHE STRING "curl library")
	SET(CURL_LIBRARIES "${CURL_LIBRARY}" CACHE STRING "curl library")
